...
ath.intl = {
	...
	id_id: {
		ios: 'Untuk menambahkan aplikasi web ini ke layar beranda: tap %icon lalu <strong> Tambahkan ke Layar Beranda </strong>.',
		android: 'Untuk menambahkan aplikasi web ini ke layar beranda, buka menu opsi browser dan ketuk <strong> Tambahkan ke layar beranda </strong>. <small> Menu dapat diakses dengan menekan tombol perangkat keras menu jika perangkat Anda memilikinya, atau dengan mengetuk ikon menu kanan atas ikon%. </small>'
	},
